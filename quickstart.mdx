...
You need an API key with `scrapes:write`, `scrapes:read`, and `datasets:read`. Configure `GMSCRAPER_API_KEY` in your local environment or secret manager. Use a test key for this walkthrough; its data is simulated.
...
```json
{"data":{"id":"job_01K4GMAPSEXAMPLE0000000000","operation":"places.search","status":"queued","created_at":"2026-09-01T10:00:00.000Z","progress":{"completed_queries":0,"total_queries":1},"links":{"self":"/api/v1/scrapes/job_01K4GMAPSEXAMPLE0000000000","results":"/api/v1/scrapes/job_01K4GMAPSEXAMPLE0000000000/results"}},"request_id":"req_01K4GMAPSEXAMPLE0000000000","schema_version":"2026-09-22"}
```
